...
namespace NXSG.Core
{
    ...
    public static class NodeCatalog
    {
        private static readonly string[] Operations =
        {
            ...
            "core.splitColor", "core.combineColor", "core.luminance", "core.contrast", "core.saturation", "core.hueShift", "core.splitUV", "core.combineUV",
        ...
        private static readonly Dictionary<string, string[]> Inputs = new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            ["core.splitColor"] = new[] { "color" }, ["core.combineColor"] = new[] { "r", "g", "b", "a" }, ["core.luminance"] = new[] { "color" }, ["core.contrast"] = new[] { "color", "amount", "pivot" }, ["core.saturation"] = new[] { "color", "amount" }, ["core.hueShift"] = new[] { "color", "hue" }, ["core.splitUV"] = new[] { "uv" }, ["core.combineUV"] = new[] { "u", "v" },
        ...
        private static readonly Dictionary<string, string[]> Outputs = new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            ["core.splitColor"] = new[] { "r", "g", "b", "a" }, ["core.combineColor"] = new[] { "color" }, ["core.luminance"] = new[] { "value" }, ["core.contrast"] = new[] { "color" }, ["core.saturation"] = new[] { "color" }, ["core.hueShift"] = new[] { "color" }, ["core.splitUV"] = new[] { "u", "v" }, ["core.combineUV"] = new[] { "uv" },
        ...
        public static string Category(string operation)
        {
            ...
            switch (operation)
            {
                ...
                case "core.splitColor": case "core.combineColor": case "core.luminance": case "core.contrast": case "core.saturation": case "core.hueShift": return "Color";
