...
namespace NXSG.Core
{
    ...
    public static class FeatureNodes
    {
        static readonly Dictionary<string,FeatureNode> Items = new Dictionary<string,FeatureNode>(StringComparer.Ordinal)
        {
            ...
            ["core.fur"] = D("Fur","Surface","Layered shell fur over an existing surface. Cards-only mode generates flat fur cards across the mesh without shell passes.","base:surface,rootColor:color,tipColor:color,length:float,density:float,thickness:float,mask:float,groom:vector3,time:float","surface:surface",false,new JObject{{"cardsOnly",0},{"fins",0},{"finOpacity",.7},{"layers",16},{"length",.04},{"density",100},{"thickness",.35},{"taper",1},{"gravity",.1},{"windStrength",.1},{"windSpeed",1},{"windScale",2},{"rimStrength",.25},{"lodNear",5},{"lodFar",15},{"minLayers",4},{"receiveShadows",1},{"selfShadowQuality",0},{"selfShadowStrength",1},{"selfShadowBias",.03}}),
