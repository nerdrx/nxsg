...
namespace NXSG.Core
{
    ...
    public static class FeatureNodes
    {
        ...
        {
            ["core.fur"] = D("Fur","Surface","Layered shell fur over an existing surface. Control length and coverage, groom in object space, color roots and tips, and animate wind. More layers add mesh passes.","base:surface,rootColor:color,tipColor:color,length:float,density:float,thickness:float,mask:float,groom:vector3,time:float","surface:surface",false,new JObject{{"layers",16},{"length",.04},{"density",100},{"thickness",.35},{"taper",1},{"gravity",.1},{"windStrength",.1},{"windSpeed",1},{"windScale",2},{"rimStrength",.25},{"lodNear",5},{"lodFar",15},{"minLayers",4}}),
