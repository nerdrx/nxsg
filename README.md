...
**38 nodes to build with.** Toon, Unlit and PBR surfaces; AudioLink, color ramps, rim glow, masked layers, stickers, dissolve, flipbooks, UV distortion, vertex motion and up to eight nested transparent shells. Fold reusable Patterns and preview intermediate values. Stacked fur, fins, LOD and baking remain future work.
